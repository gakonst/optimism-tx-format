// We copy-paste this code from https://github.com/ethereum-optimism/go-ethereum/blob/master/core/state_transition_ovm.go
// for this example because the functions are not exported
package ovm
